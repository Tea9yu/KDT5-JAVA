	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1: // 인큐
				...
				try {
					oq.enque(rndx);
				} catch(Chap4_stack_que.IntQueue3.OverflowIntQueue3Exception e) {
			...
			case 2: // 디큐
				...
				} catch (Chap4_stack_que.IntQueue3.EmptyIntQueue3Exception e) {
					System.out.println("큐가 비어 있습니다.");
				}
				break;
