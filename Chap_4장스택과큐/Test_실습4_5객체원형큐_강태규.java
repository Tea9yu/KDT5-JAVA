...
public class Test_실습4_5객체원형큐_강태규 {
	...
	public Test_실습4_5객체원형큐_강태규(int count) {
		QUEUE_SIZE = count;
...
public static void main(String[] args) {
	...
	Test_실습4_5객체원형큐_강태규 oq = new Test_실습4_5객체원형큐_강태규(4); // 최대 64개를 인큐할 수 있는 큐
	...
	while (true) {
		...
		case 1: // 인큐
			...
			try {
				oq.push(p);
			} catch(Test_실습4_5객체원형큐_강태규.OverflowQueueException e) {
		...
		case 2: // 디큐
			...
			} catch (Test_실습4_5객체원형큐_강태규.EmptyQueueException e) {
				System.out.println("큐가 비어 있습니다.");
			}
			break;
